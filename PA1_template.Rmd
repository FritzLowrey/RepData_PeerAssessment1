...
Mean is `r format(stepmean, 3)`  
Median is `r format(stepmedian, 3)`
...
Interval with highest average step count = `r maxinterval`
...
Total number of *missing step data* is `r missing`
...
Mean for original data is `r format(stepmean, 3)`  
Median for original data is `r format(stepmedian, 3)`

Mean for revised data is `r format(new_stepmean, 3)`  
Median for revised data is `r format(new_stepmedian, 3)`
